...
.method private calculateAndUpdateOpDelay(JJIIJLcom/google/android/gm/provider/Operations$OperationInfo;Lcom/google/android/gm/provider/MailEngine$SyncInfo;Lcom/google/android/gm/provider/MailEngine;)Z
    ...
    .param p5, "numAttempts"    # I
    .param p6, "delay"    # I
    .param p7, "nextTimeToAttempt"    # J
    .param p9, "opInfo"    # Lcom/google/android/gm/provider/Operations$OperationInfo;
    .param p10, "syncInfo"    # Lcom/google/android/gm/provider/MailEngine$SyncInfo;
    .param p11, "mailEngine"    # Lcom/google/android/gm/provider/MailEngine;
    ...
    .line 478
    .restart local v11    # "delayBadOp":Z
    :cond_1
    ...
    .end local v12    # "newAttempts":I
    .end local v13    # "newOpId":J
    :cond_4
    const v1, 0x15180
...
.method private moveOperationToEnd(JLcom/google/android/gm/provider/Operations$OperationInfo;Lcom/google/android/gm/provider/MailEngine$SyncInfo;IJI)J
    ...
    .param p3, "opInfo"    # Lcom/google/android/gm/provider/Operations$OperationInfo;
    .param p4, "syncInfo"    # Lcom/google/android/gm/provider/MailEngine$SyncInfo;
    .param p5, "numAttempts"    # I
    .param p6, "nextTimeToAttempt"    # J
    .param p8, "delay"    # I
...
.method public static updateLabelId(Landroid/database/sqlite/SQLiteDatabase;JJ)V
    ...
    .param p1, "currentLabelId"    # J
    .param p3, "newLabelId"    # J
...
.method public incrementAndAddOperations(Lcom/google/android/gm/provider/Operations$OperationInfo;)J
    .locals 31
    .param p1, "opInfo"    # Lcom/google/android/gm/provider/Operations$OperationInfo;
...
.method public recordOperation(JJLjava/lang/String;JIJ)J
    ...
    .param p3, "messageId"    # J
    .param p5, "action"    # Ljava/lang/String;
    .param p6, "numAttempts"    # J
    .param p8, "delay"    # I
    .param p9, "nextTimeToAttempt"    # J
...
.method public recordOperationWithLabelId(JJLjava/lang/String;JJIJ)J
    ...
    .param p5, "action"    # Ljava/lang/String;
    .param p6, "labelId"    # J
    .param p8, "numAttempts"    # J
    .param p10, "delay"    # I
    .param p11, "nextTimeToAttempt"    # J
