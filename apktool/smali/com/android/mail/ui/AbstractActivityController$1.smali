...
.method public registerObserver(Landroid/database/DataSetObserver;)V
    ...
    .prologue
    .line 184
    iget-object v1, p0, Lcom/android/mail/ui/AbstractActivityController$1;->mObservers:Ljava/util/ArrayList;
    ...
    const-string v2, "IN AAC.register(List)Observer: %s before=%d after=%d"
    ...
    iget-object v5, p0, Lcom/android/mail/ui/AbstractActivityController$1;->mObservers:Ljava/util/ArrayList;
...
.method public bridge synthetic registerObserver(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/mail/ui/AbstractActivityController$1;->registerObserver(Landroid/database/DataSetObserver;)V
...
.method public unregisterObserver(Landroid/database/DataSetObserver;)V
    ...
    const-string v2, "IN AAC.unregister(List)Observer: %s before=%d after=%d"
...
.method public bridge synthetic unregisterObserver(Ljava/lang/Object;)V
    ...
    .end local p1    # "x0":Ljava/lang/Object;
    invoke-virtual {p0, p1}, Lcom/android/mail/ui/AbstractActivityController$1;->unregisterObserver(Landroid/database/DataSetObserver;)V
