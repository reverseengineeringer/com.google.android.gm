...
{
  public ftd(SelectedAccountNavigationView paramSelectedAccountNavigationView) {}
  
  public final void onClick(View paramView)
  {
    if ((a.q != null) && (a.g != null) && (!a.g.isEmpty()))
    {
      paramView = a.q;
      a.g.get(0);
      if (!paramView.a()) {}
    ...
    Object localObject3 = j.l;
    Object localObject2 = j.p;
    ((View)localObject3).bringToFront();
    Object localObject1 = (fyb)g.get(0);
    if (n == 0.0F) {
      n = j.p.getWidth();
    }
