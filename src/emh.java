...
public final class emh
{
  public static int a(Parcel paramParcel)
  {
    ...
    if ((0xFFFF & j) != 20293) {
      throw new emi("Expected object header. Got 0x" + Integer.toHexString(j), paramParcel);
    }
    j = i + k;
    if ((j < i) || (j > paramParcel.dataSize())) {
      throw new emi("Size read is invalid start=" + i + " end=" + j, paramParcel);
    }
    return j;
  }
  ...
  public static void a(Parcel paramParcel, int paramInt1, int paramInt2)
  {
    if (paramInt1 != paramInt2) {
      throw new emi("Expected size " + paramInt2 + " got " + paramInt1 + " (0x" + Integer.toHexString(paramInt1) + ")", paramParcel);
    }
  }
  ...
  public static double[] r(Parcel paramParcel, int paramInt)
  {
    paramInt = a(paramParcel, paramInt);
    int i = paramParcel.dataPosition();
    if (paramInt == 0) {
  ...
  public static ArrayList<String> u(Parcel paramParcel, int paramInt)
  {
    paramInt = a(paramParcel, paramInt);
    int i = paramParcel.dataPosition();
    if (paramInt == 0) {
