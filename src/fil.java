  ...
  implements fij
{
  ...
  /* Error */
  public final void a(com.google.android.gms.drive.realtime.internal.ParcelableIndexReference paramParcelableIndexReference)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_2
    ...
    //   24: aload_2
    //   25: iconst_0
    //   26: invokevirtual 55	com/google/android/gms/drive/realtime/internal/ParcelableIndexReference:writeToParcel	(Landroid/os/Parcel;I)V
    //   29: aload_0
    //   30: getfield 15	fil:a	Landroid/os/IBinder;
    //   33: iconst_1
    //   34: aload_2
    ...
    //   start	length	slot	name	signature
    //   0	75	0	this	fil
    //   0	75	1	paramParcelableIndexReference	com.google.android.gms.drive.realtime.internal.ParcelableIndexReference
    //   3	67	2	localParcel1	android.os.Parcel
    //   7	59	3	localParcel2	android.os.Parcel
    // Exception table:
    //   from	to	target	type
