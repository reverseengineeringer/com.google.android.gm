...
{
  public static final Parcelable.Creator<MediaMetadataCompat> CREATOR = new lt();
  private static final ns<String, Integer> a;
  ...
  static
  {
    ns localns = new ns();
    a = localns;
    localns.put("android.media.metadata.TITLE", Integer.valueOf(1));
