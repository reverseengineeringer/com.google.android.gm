  ...
  extends LinearLayout
{
  ...
  public ButtonBarLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, ack.am);
    a = paramContext.getBoolean(ack.an, false);
    ...
    if ((!a()) && (View.MeasureSpec.getMode(paramInt1) == 1073741824))
    {
      ...
      if (a)
      {
        ...
        if (!a())
        {
          ...
          j = m;
          if ((rg.h(this) & 0xFF000000) == 16777216) {
            j = 1;
          }
        }
      }
