  ...
  implements gx, gy
{
  ...
  {
    c.add(id.a(a, paramhz));
  }
  
  public final Notification b()
  {
    Notification localNotification = a.build();
    Object localObject = id.a(localNotification);
    ...
    localObject = id.a(c);
    if (localObject != null) {
      id.a(localNotification).putSparseParcelableArray("android.support.actionExtras", (SparseArray)localObject);
    }
