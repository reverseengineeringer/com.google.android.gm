...
{
  public static final Parcelable.Creator<ValuesSetDetails> CREATOR = new fhf();
  final int a;
  final int b;
  final int c;
  final int d;
  
  public ValuesSetDetails(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    a = paramInt1;
    b = paramInt2;
    c = paramInt3;
