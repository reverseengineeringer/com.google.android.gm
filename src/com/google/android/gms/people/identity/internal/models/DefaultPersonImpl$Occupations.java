...
public final class DefaultPersonImpl$Occupations
  ...
  implements SafeParcelable
{
  ...
  public DefaultPersonImpl$Occupations()
  {
    b = 1;
    a = new HashSet();
  }
  
  public DefaultPersonImpl$Occupations(Set<Integer> paramSet, int paramInt, DefaultMetadataImpl paramDefaultMetadataImpl, String paramString)
  {
    a = paramSet;
    b = paramInt;
  ...
  {
    if (!(paramObject instanceof Occupations)) {
      return false;
    }
    if (this == paramObject) {
      return true;
    }
    paramObject = (Occupations)paramObject;
    ...
    while (localIterator.hasNext())
    {
      ...
      if (a(localField))
      {
        if (((Occupations)paramObject).a(localField))
        {
          if (!b(localField).equals(((Occupations)paramObject).b(localField))) {
            return false;
          }
        }
        else {
      ...
      else if (((Occupations)paramObject).a(localField)) {
        return false;
      }
    }
    return true;
...
/* Location:
 * Qualified Name:     com.google.android.gms.people.identity.internal.models.DefaultPersonImpl.Occupations
