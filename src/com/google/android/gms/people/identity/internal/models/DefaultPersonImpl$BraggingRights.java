...
public final class DefaultPersonImpl$BraggingRights
  extends FastJsonResponse
  implements SafeParcelable
{
  public static final fvu CREATOR = new fvu();
  ...
  public DefaultPersonImpl$BraggingRights()
  {
    b = 1;
    a = new HashSet();
  }
  
  public DefaultPersonImpl$BraggingRights(Set<Integer> paramSet, int paramInt, DefaultMetadataImpl paramDefaultMetadataImpl, String paramString)
  {
    a = paramSet;
    b = paramInt;
  ...
  {
    if (!(paramObject instanceof BraggingRights)) {
      return false;
    }
    if (this == paramObject) {
      return true;
    }
    paramObject = (BraggingRights)paramObject;
    ...
    while (localIterator.hasNext())
    {
      ...
      if (a(localField))
      {
        if (((BraggingRights)paramObject).a(localField))
        {
          if (!b(localField).equals(((BraggingRights)paramObject).b(localField))) {
            return false;
          }
        }
        else {
      ...
      else if (((BraggingRights)paramObject).a(localField)) {
        return false;
      }
    }
    return true;
...
/* Location:
 * Qualified Name:     com.google.android.gms.people.identity.internal.models.DefaultPersonImpl.BraggingRights
