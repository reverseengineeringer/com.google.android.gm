...
public final class DefaultPersonImpl$Nicknames
  ...
  implements SafeParcelable
{
  ...
  public DefaultPersonImpl$Nicknames()
  {
    b = 1;
    a = new HashSet();
  }
  
  public DefaultPersonImpl$Nicknames(Set<Integer> paramSet, int paramInt, DefaultMetadataImpl paramDefaultMetadataImpl, String paramString1, String paramString2)
  {
    a = paramSet;
    b = paramInt;
  ...
  {
    if (!(paramObject instanceof Nicknames)) {
      return false;
    }
    if (this == paramObject) {
      return true;
    }
    paramObject = (Nicknames)paramObject;
    ...
    while (localIterator.hasNext())
    {
      ...
      if (a(localField))
      {
        if (((Nicknames)paramObject).a(localField))
        {
          if (!b(localField).equals(((Nicknames)paramObject).b(localField))) {
            return false;
          }
        }
        else {
      ...
      else if (((Nicknames)paramObject).a(localField)) {
        return false;
      }
    }
    return true;
...
/* Location:
 * Qualified Name:     com.google.android.gms.people.identity.internal.models.DefaultPersonImpl.Nicknames
