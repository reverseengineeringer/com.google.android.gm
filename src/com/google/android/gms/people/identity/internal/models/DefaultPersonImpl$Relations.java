...
public final class DefaultPersonImpl$Relations
  ...
  implements SafeParcelable
{
  ...
  public DefaultPersonImpl$Relations()
  {
    b = 1;
    a = new HashSet();
  }
  
  public DefaultPersonImpl$Relations(Set<Integer> paramSet, int paramInt, String paramString1, DefaultMetadataImpl paramDefaultMetadataImpl, String paramString2, String paramString3)
  {
    a = paramSet;
    b = paramInt;
    c = paramString1;
  ...
  {
    if (!(paramObject instanceof Relations)) {
      return false;
    }
    if (this == paramObject) {
      return true;
    }
    paramObject = (Relations)paramObject;
    ...
    while (localIterator.hasNext())
    {
      ...
      if (a(localField))
      {
        if (((Relations)paramObject).a(localField))
        {
          if (!b(localField).equals(((Relations)paramObject).b(localField))) {
            return false;
          }
        }
        else {
      ...
      else if (((Relations)paramObject).a(localField)) {
        return false;
      }
    }
    return true;
...
/* Location:
 * Qualified Name:     com.google.android.gms.people.identity.internal.models.DefaultPersonImpl.Relations
