...
public final class DefaultPersonImpl$Genders
  extends FastJsonResponse
  implements SafeParcelable
{
  public static final fvz CREATOR = new fvz();
  ...
  public DefaultPersonImpl$Genders()
  {
    b = 1;
    a = new HashSet();
  }
  
  public DefaultPersonImpl$Genders(Set<Integer> paramSet, int paramInt, String paramString1, DefaultMetadataImpl paramDefaultMetadataImpl, String paramString2)
  {
    a = paramSet;
    b = paramInt;
    c = paramString1;
  ...
  {
    if (!(paramObject instanceof Genders)) {
      return false;
    }
    if (this == paramObject) {
      return true;
    }
    paramObject = (Genders)paramObject;
    ...
    while (localIterator.hasNext())
    {
      ...
      if (a(localField))
      {
        if (((Genders)paramObject).a(localField))
        {
          if (!b(localField).equals(((Genders)paramObject).b(localField))) {
            return false;
          }
        }
        else {
      ...
      else if (((Genders)paramObject).a(localField)) {
        return false;
      }
    }
    return true;
...
/* Location:
 * Qualified Name:     com.google.android.gms.people.identity.internal.models.DefaultPersonImpl.Genders
