...
public final class DefaultPersonImpl$Taglines
  ...
  implements SafeParcelable
{
  ...
  public DefaultPersonImpl$Taglines()
  {
    b = 1;
    a = new HashSet();
  }
  
  public DefaultPersonImpl$Taglines(Set<Integer> paramSet, int paramInt, DefaultMetadataImpl paramDefaultMetadataImpl, String paramString)
  {
    a = paramSet;
    b = paramInt;
  ...
  {
    if (!(paramObject instanceof Taglines)) {
      return false;
    }
    if (this == paramObject) {
      return true;
    }
    paramObject = (Taglines)paramObject;
    ...
    while (localIterator.hasNext())
    {
      ...
      if (a(localField))
      {
        if (((Taglines)paramObject).a(localField))
        {
          if (!b(localField).equals(((Taglines)paramObject).b(localField))) {
            return false;
          }
        }
        else {
      ...
      else if (((Taglines)paramObject).a(localField)) {
        return false;
      }
    }
    return true;
...
/* Location:
 * Qualified Name:     com.google.android.gms.people.identity.internal.models.DefaultPersonImpl.Taglines
