...
public final class DefaultPersonImpl$RelationshipInterests
  ...
  implements SafeParcelable
{
  ...
  public DefaultPersonImpl$RelationshipInterests()
  {
    b = 1;
    a = new HashSet();
  }
  
  public DefaultPersonImpl$RelationshipInterests(Set<Integer> paramSet, int paramInt, DefaultMetadataImpl paramDefaultMetadataImpl, String paramString)
  {
    a = paramSet;
    b = paramInt;
  ...
  {
    if (!(paramObject instanceof RelationshipInterests)) {
      return false;
    }
    if (this == paramObject) {
      return true;
    }
    paramObject = (RelationshipInterests)paramObject;
    ...
    while (localIterator.hasNext())
    {
      ...
      if (a(localField))
      {
        if (((RelationshipInterests)paramObject).a(localField))
        {
          if (!b(localField).equals(((RelationshipInterests)paramObject).b(localField))) {
            return false;
          }
        }
        else {
      ...
      else if (((RelationshipInterests)paramObject).a(localField)) {
        return false;
      }
    }
    return true;
...
/* Location:
 * Qualified Name:     com.google.android.gms.people.identity.internal.models.DefaultPersonImpl.RelationshipInterests
