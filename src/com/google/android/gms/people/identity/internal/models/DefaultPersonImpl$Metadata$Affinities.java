...
public final class DefaultPersonImpl$Metadata$Affinities
  extends FastJsonResponse
  implements SafeParcelable
{
  public static final fwf CREATOR = new fwf();
  ...
  public DefaultPersonImpl$Metadata$Affinities()
  {
    b = 1;
    a = new HashSet();
  }
  
  public DefaultPersonImpl$Metadata$Affinities(Set<Integer> paramSet, int paramInt, String paramString, double paramDouble)
  {
    a = paramSet;
    b = paramInt;
    c = paramString;
...
/* Location:
 * Qualified Name:     com.google.android.gms.people.identity.internal.models.DefaultPersonImpl.Metadata.Affinities
