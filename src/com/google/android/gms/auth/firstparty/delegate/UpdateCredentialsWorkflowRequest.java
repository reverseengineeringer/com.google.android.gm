...
{
  public static final efz CREATOR = new efz();
  final int a;
  @Deprecated
  String b;
  AppDescription c;
  ...
  public UpdateCredentialsWorkflowRequest(int paramInt, String paramString, AppDescription paramAppDescription, Bundle paramBundle, Account paramAccount, AccountAuthenticatorResponse paramAccountAuthenticatorResponse)
  {
    a = paramInt;
    b = paramString;
...
/* Location:
 * Qualified Name:     com.google.android.gms.auth.firstparty.delegate.UpdateCredentialsWorkflowRequest
